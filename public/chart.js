;(function(window) {
  ...
  function drawLineChart( elementId, data ) {
    ...
    var containerEl = document.getElementById( elementId ),
        ...
        area = d3.svg.area()
                      .interpolate( 'linear' )
                      .x( function( d )  { return x( d.time ) + detailWidth / 2; } )
                      .y0( height )
    ...
    // hacky hacky hacky :(
    y.domain( [ 0, d3.max( data, function( d ) { return d.currentLoad; } ) + 700 ] );
  ...
  window.drawLineChart = function(elementId) {
    drawLineChart(elementId, data.lineChart);
  };
